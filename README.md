...
* [Cargo](https://crates.io/) — the Rust package manager
  ...
  * [cargo-rpm](https://github.com/iqlusioninc/cargo-rpm) [[cargo-rpm](https://crates.io/crates/cargo-rpm)] — cargo subcommand for building .rpm releases of Rust projects.
...
* ORM [[orm](https://crates.io/keywords/orm)]
  * [Brendonovich/prisma-client-rust](https://github.com/Brendonovich/prisma-client-rust) — Prisma Client Rust is an autogenerated query builder that provides simple and fully type-safe database access without macros or domain-specific languages. [![Test Status](https://img.shields.io/github/workflow/status/Brendonovich/prisma-client-rust/CI?label=tests&style=flat-square)](https://github.com/Brendonovich/prisma-client-rust/actions)
...
* WireGuard®
  * [firezone/wireguardex](https://github.com/firezone/wireguardex) - WireGuardex is a library to configure WireGuard® interfaces. Written in Rust and Elixir, used by [Firezone](https://github.com/firezone/firezone).
* ZeroMQ
...
* Miscellaneous
  ...
  * [homelyguy/dyer](https://github.com/HomelyGuy/dyer) [[dyer](https://crates.io/crates/dyer)] - dyer is designed for reliable, flexible and fast Request-Response based service, including data processing, web-crawling and so on, providing some friendly, flexible, comprehensive features without compromising speed.
